...
init python:
    import math
    def elliptical_movement_x(trans, st, at):
        trans.xcenter = 0.5 + 0.01 * math.sin(2 * math.pi * st / 4.0)
        return 0   
    def elliptical_movement_y(trans, st, at):
    ...
    block:
        ...
        choice (0.5):
            block:
                choice:
                    parallel:
                        function elliptical_movement_y
                    parallel:
